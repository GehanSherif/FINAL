...
public:
	...
	graphicsInfo DropCourse(int X, int Y,SEMESTER sem);
	Course* getpCRS(int x, int y,SEMESTER sem);
	list<Course*>* getlist(SEMESTER sem);
	int getsemcredits(SEMESTER sem) const;
